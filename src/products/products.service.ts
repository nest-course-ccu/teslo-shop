...
export class ProductsService {
  ...
  async create(createProductDto: CreateProductDto) {
    try {
      ...
      await this.productRepository.save(product); // save product and images
  ...
  async update(id: string, updateProductDto: UpdateProductDto) {
    ...
    try {
      ...
      await queryRunner.release(); // ya no funciona el queryrunner
  ...
  async remove(id: string) {
    ...
    const del = await this.productRepository.remove(product);
    return del;
  }
